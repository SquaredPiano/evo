...
const STEPS: TutorialStep[] = [
  ...
  },
  {
    id: "overview",
    title: "Results Ready",
    description: "Your analysis is complete. Explore the scores and summary, then open the \"Structure\" tab in the header.",
    icon: Dna,
  ...
  },
  {
    ...
    description: "Hover any sphere to see its confidence score. Open the \"Sequence\" tab in the header to inspect individual DNA bases.",
    icon: Box,
  ...
  },
  {
    ...
    description: "Click any colored base to inspect it, then edit bases right in the sequence workspace.",
    icon: Search,
  },
  {
    id: "studio",
    title: "Simulate Mutations",
    description: "In the Mutation Editor, enter a position, pick a target base, and click \"Run simulation\" to see the predicted impact.",
    icon: Pencil,
  },
  {
    id: "copilot",
